...
class AppController(QObject):
    ...
    def start(self) -> None:
        ...
        self._tray.set_steps(describe(self._context.settings.processing))
    ...
    def _on_settings_saved(self) -> None:
        ...
        self._tray.set_steps(describe(settings.processing))
