...
готовую инструкцию для AI-модели, а результат вставляет прямо в то окно, где
вы работали.
...
| Что говорите | Что получаете | Как включить |
| --- | --- | --- |
| Поток мыслей по-русски | Чистый текст с пунктуацией | Шаг «Очистка» |
| Мысль по-русски для англоязычного чата | Готовый английский текст | Шаг «Перевод на английский» |
| Расплывчатое «хочу вот такое» | Структурированная инструкция для AI | Шаг «Инструкция для AI» |

Шаги независимы и складываются в цепочку: можно включить только очистку, а
можно очистку и перевод сразу.
